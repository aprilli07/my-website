...
export default function Experience() {
    const experiences = [
        ...
        },
        {
            ...
            description: ["Developed and optimized reusable UI components in Next.js and TypeScript, improving frontend maintainability andreducing unnecessary re-renders through refactored component structure and state management", 
